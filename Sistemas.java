...
Logica cambiar=new Logica();
    ...
    private void initComponents() {
        ...
        TrenesDisponiblesRoma = new javax.swing.JLabel();
        ...
        TrenesDisponiblesRoma.setFont(new java.awt.Font("Segoe UI", 2, 12)); // NOI18N
        TrenesDisponiblesRoma.setForeground(new java.awt.Color(0, 0, 0));
        TrenesDisponiblesRoma.setText("0");
        getContentPane().add(TrenesDisponiblesRoma, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, 90, -1));
    ...
    public void CambiarEtiqueta(String NombreDeEtiqueta,int valor){
      ...
      switch(NombreDeEtiqueta){
          ...
          case "Roma" -> {
              ...
              TrenesDisponiblesRoma.setText("1");
            }
          case "Napoles" -> {
...
//          PILAS
          ...
          case "TrenRoma"-> {
              TrenesDisponiblesRoma.setText(dato);
          }
          case "TrenMilan"-> {
              TrenDisponibleMilan.setText(dato);
          }
          case "TrenNapoles"-> {
              TrenDisponibleNaples.setText(dato);
          }
           case "TrenVenicia"-> {
              TrenDisponibleVenice.setText(dato);
          }
           case "TrenFlorencia"-> {
              TrenDisponibleFlorencia.setText(dato);
          }
    ...
    public void Arranque(){
      ...
      //inicializando guardarFilas
       ...
       //inicializando guardarTrenes
      int guardarTrenRoma; 
       int guardarTrenNapoles;
       int guardarTrenMilan;
       int guardarTrenVenecia;
       int guardarTrenFlorencia;
...
//        NCuidad=4   Florencia
       ...
       guardarFilaRoma = cambiar.ContarPersonas(0);//roma
       guardarFilaNapoles = cambiar.ContarPersonas(1);//napoles
       guardarFilaMilan = cambiar.ContarPersonas(2);//Milan
       guardarFilaVenecia = cambiar.ContarPersonas(3);//Venenicia
       guardarFilaFlorencia = cambiar.ContarPersonas(4);//Florencia
       ...
       guardarTrenRoma=cambiar.ContarTrenes(0);
       guardarTrenNapoles=cambiar.ContarTrenes(1);
       guardarTrenMilan=cambiar.ContarTrenes(2);
       guardarTrenVenecia=cambiar.ContarTrenes(3);
       guardarTrenFlorencia=cambiar.ContarTrenes(4);
       //
       ...
       CambiarEtiqueta("PilaFlorencia", guardarPilaFlorencia);
         ...
         CambiarEtiqueta("TrenRoma",guardarTrenRoma);
       CambiarEtiqueta("TrenNapoles", guardarTrenNapoles);
       CambiarEtiqueta("TrenMilan", guardarTrenMilan);
       CambiarEtiqueta("TrenVenicia", guardarTrenVenecia);
       CambiarEtiqueta("TrenFlorencia", guardarTrenFlorencia);
    ...
    private javax.swing.JLabel TrenesDisponiblesRoma;
